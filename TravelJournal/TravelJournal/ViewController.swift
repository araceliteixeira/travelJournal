...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    func loadData() {
        ...
        album1.setStartDate("2015-10-24", dateFormat)
        album1.setEndDate("2015-11-01", dateFormat)
        album1.setDescrption("First time overseas! Just my husband and I, a lovely trip!")
        
        var record = Record("London day 1", "2015-10-26", UIColor.blue, dateFormat)
        ...
        record = Record("London day 2", "2015-10-27", UIColor.blue, dateFormat)
        ...
        album1.addRecord(record)
        record = Record("London day 3", "2015-10-28", UIColor.blue, dateFormat)
        ...
        album1.addRecord(record)
        record = Record("Paris", "2015-10-29", UIColor.blue, dateFormat)
        ...
        album1.addRecord(record)
        record = Record("Rome", "2015-10-31", UIColor.blue, dateFormat)
        ...
        album2.setStartDate("2016-03-10", dateFormat)
        album2.setEndDate("2016-03-15", dateFormat)
        album2.setDescrption("Our second honeymoon")
        
        record = Record("Beautiful view", "2016-03-15", UIColor.green, dateFormat)
